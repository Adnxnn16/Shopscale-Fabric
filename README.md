...
### 1. Landing Hero
![Shopscale Fabric](screenshots/1.Shopscale%20Fabric.png)

### 2. Sign In
![Sign In](screenshots/2.Sing%20In.png)

### 3. Home Page
![Home Page](screenshots/3.Home%20Page.png)

### 4. Categories Navigation
![Categories](screenshots/4.Categories.png)

### 5. New Arrivals
![New Arrivals](screenshots/5.New%20Arrivals.png)

### 6. Shopping Cart
![Your Cart](screenshots/6.Your%20Cart.png)

### 7. Place Order
![Place Order](screenshots/7.Place%20Order.png)

### 8. Order Confirmation (with Inventory status check)
![Order Confirm](screenshots/8.Order%20Confirm.png)
